...
fn = "/astro/data/d0305/data0305/data0305" # parameter file to load
...
halo_list.write_out("d0305_HopAnalysis.txt")
'''
file_to_write = '/tmp/d0305_clumps_out1_test.txt' 
c = [4.031041336e-01  ,  4.716763146e-01  ,  4.615712357e-01] # densest cell coord.
