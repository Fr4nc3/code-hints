...
fn = "/astro/data/d0306/data0306/data0306" # parameter file to load
...
'''
#Step #1 Calculate HALO
halo_list = HaloFinder(pf)
halo_list.write_out("d0306_HopAnalysis.txt")
'''

file_to_write = '/tmp/d0306_clumps_out1_test.txt' 
c = [4.031828656e-01  ,  4.717151386e-01  ,  4.614570797e-01] # densest cell coord.
