...
#step #1  get the center 
'''
halo_list = HaloFinder(pf)
halo_list.write_out("d0299_HopAnalysis.txt")

'''
file_to_write = '/tmp/d0299_clumps_out1_test.txt' 
c = [4.026331263e-01   , 4.714540963e-01   , 4.622243906e-01 ] # densest cell coord.
