...
#alpha=10.0*na.ones(4,dtype='float64')
alpha = [0.007, 0.07, 0.15, 0.7, 0.9, 0.95, 1.0] #[0.01, 0.1, 0.6, 0.7, 0.8, 0.9, 1.0]
frame = 0
tf.clear()
tf.add_layers(7, colormap="kamae", w=0.015,alpha=alpha,mi=mi,col_bounds = [-27.5,-25.5], ma=ma)
