...
fn = "/astro/data/d0304/data0304/data0304" # parameter file to load
...
halo_list.write_out("d0304_HopAnalysis.txt")
'''

file_to_write = '/tmp/d0304_clumps_out1_test.txt' 
c = [4.030269645e-01 ,   4.716397766e-01  ,  4.616750455e-01] # densest cell coord.
