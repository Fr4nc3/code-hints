...
halo_list.write_out("d0301_HopAnalysis.txt")
'''
file_to_write = '/tmp/d0301_clumps_out1_test.txt' 
c = [4.067627915e-01 ,   4.723197619e-01 ,   4.596178269e-01] # densest cell coord.
