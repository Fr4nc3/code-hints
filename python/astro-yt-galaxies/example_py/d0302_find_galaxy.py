...
fn = "/astro/data/d0302/data0302/data0302" # parameter file to load
...
halo_list.write_out("d0302_HopAnalysis.txt")
'''
file_to_write = '/tmp/d0302_clumps_out1_test.txt' 
c = [4.028744583e-01 ,   4.715630154e-01 ,   4.618947428e-01] # densest cell coord.
